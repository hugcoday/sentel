...
// RpcApiServiceFactory
type RpcApiServiceFactory struct{}

// New create apiService service factory
func (m *RpcApiServiceFactory) New(protocol string, c libs.Config, ch chan base.ServiceCommand) (base.Service, error) {
	address := ":50051"
	server := &RpcApiService{config: c, wg: sync.WaitGroup{}}
...
// Name
func (s *RpcApiService) Info() *base.ServiceInfo {
...
// Start
func (s *RpcApiService) Start() error {
	go func(s *RpcApiService) {
...
//
// Wait
func (s *RpcApiService) Wait() {
	s.wg.Wait()
}

func (s *RpcApiService) Version(ctx context.Context, req *VersionRequest) (*VersionReply, error) {
	version := base.GetServiceManager().GetVersion()
	return &VersionReply{Version: version}, nil
}

func (s *RpcApiService) Admins(ctx context.Context, req *AdminsRequest) (*AdminsReply, error) {
	return nil, nil
}

func (s *RpcApiService) Cluster(ctx context.Context, req *ClusterRequest) (*ClusterReply, error) {
	return nil, nil
}

// Routes delegate routes command
func (s *RpcApiService) Routes(ctx context.Context, req *RoutesRequest) (*RoutesReply, error) {
...
func (s *RpcApiService) Status(ctx context.Context, req *StatusRequest) (*StatusReply, error) {
	return nil, nil
}

// Broker delegate broker command implementation in sentel
func (s *RpcApiService) Broker(ctx context.Context, req *BrokerRequest) (*BrokerReply, error) {
	mgr := base.GetServiceManager()
	switch req.Category {
	case "stats":
...
func (s *RpcApiService) Plugins(ctx context.Context, req *PluginsRequest) (*PluginsReply, error) {
	return nil, nil
}

// Services delegate  services command
func (s *RpcApiService) Services(ctx context.Context, req *ServicesRequest) (*ServicesReply, error) {
	mgr := base.GetServiceManager()
	reply := &ServicesReply{
		Header:   &ReplyMessageHeader{Success: true},
...
func (s *RpcApiService) Subscriptions(ctx context.Context, req *SubscriptionsRequest) (*SubscriptionsReply, error) {
	mgr := base.GetServiceManager()
...
func (s *RpcApiService) Clients(ctx context.Context, req *ClientsRequest) (*ClientsReply, error) {
	reply := &ClientsReply{
		Clients: []*ClientInfo{},
		Header:  &ReplyMessageHeader{Success: true},
	}
...
func (s *RpcApiService) Sessions(ctx context.Context, req *SessionsRequest) (*SessionsReply, error) {
	mgr := base.GetServiceManager()
	reply := &SessionsReply{
		Header:   &ReplyMessageHeader{Success: true},
...
func (s *RpcApiService) Topics(ctx context.Context, req *TopicsRequest) (*TopicsReply, error) {
	mgr := base.GetServiceManager()
	reply := &TopicsReply{
		Header: &ReplyMessageHeader{Success: true},
		Topics: []*TopicInfo{},
